...
class TreatmentPlan:
    def __init__(
        ...
        self.angle_key_2 = None
        self.beam_weight=None
    ...
    def __str__(self):
        if self.angle_key_2!=None:
            ...
            return f'Treatment Plan for Patient {self.patient.patient_id}, Angle Key: {self.angle_key}'
